...
import { Plus, Edit2, Trash2, TrendingDown, Calendar, Tag } from "lucide-react";
...
const Egresos = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        await updateEgreso(editingId, formData);
      } else {
        await createEgreso(formData);
      }
  ...
  const calcularTotal = () => {
    return egresos.reduce((sum, egreso) => sum + egreso.monto, 0);
  };
      ...
      <div style={styles.mainContent}>
        <div style={styles.container}>
          ...
          <div style={styles.header}>
            <div>
              <h1 style={styles.title}>Mis Egresos</h1>
          ...
          <div style={styles.statsCard}>
            <div style={styles.statItem}>
              <p style={styles.statLabel}>Total Egresos</p>
            ...
            <div style={styles.statItem}>
              ...
              <p style={styles.statValue}>{egresos.length}</p>
            </div>
            <div style={styles.statDivider}></div>
            <div style={styles.statItem}>
              ...
              <p style={styles.statValue}>
                $
                {egresos.length > 0
                  ? (calcularTotal() / egresos.length).toLocaleString("es-CL", {
          ...
          <div style={styles.tableCard}>
            {egresos.length === 0 ? (
              <div style={styles.emptyState}>
                ...
                <h3 style={styles.emptyTitle}>No hay egresos registrados</h3>
                <p style={styles.emptyText}>
                  Comienza agregando tu primer egreso
                </p>
                <button
              ...
              <div style={styles.tableWrapper}>
                <table style={styles.table}>
                  ...
                  <tbody>
                    {egresos.map((egreso) => (
                      <tr key={egreso.id} style={styles.tr}>
                        ...
                        <td style={styles.td}>
                          <span
                            style={{ ...styles.montoText, color: "#ef4444" }}
                          >
